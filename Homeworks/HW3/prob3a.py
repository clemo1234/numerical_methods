...
axs[0].plot(times, sol.T[pos], label = "2-step BDF", color = "red")
axs[1].plot(times, sol_dirk2.T[pos], label = "DIRK2", color = "purple")
axs[2].plot(times, sol_dirk3.T[pos], label = "DIRKo3", color = "gold")
