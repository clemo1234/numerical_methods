...
#DIRK
A_fe = np.array([[gamma, 0], [1-gamma, gamma]])
b_fe = np.array([1-gamma, gamma])
...
plt.figure()
plt.contourf(X,Y,dirk,[0,1], colors = "pink", alpha = 0.3)
plt.contour(X,Y,dirk,[1], colors = "pink")
